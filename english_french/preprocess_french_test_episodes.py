...
french_audio_1 = {}
french_audio_labels_1 = {}
french_audio_tag_1 = {}
french_audio_2 = {}
french_audio_labels_2 = {}
french_audio_tag_2 = {}
image_1 = {}
image_labels_1 = {}
image_tag_1 = {}
...
save_fn = Path('results/files/french_episode_data')
save_fn.parent.mkdir(exist_ok=True, parents=True)
np.savez(
    save_fn,
    audio_datapoints=audio_datapoints,
    image_datapoints=image_datapoints,
    audio_1=french_audio_1,
    audio_labels_1=french_audio_labels_1,
    audio_tag_1=french_audio_tag_1,
    audio_2=french_audio_2,
    audio_labels_2=french_audio_labels_2,
    audio_tag_2=french_audio_tag_2,
    image_1=image_1,
