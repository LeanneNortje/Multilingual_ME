...
class ImageAudioDatawithSampling(Dataset):
    ...
    def _SampleNeg(self, im_name, english_wav_name, french_wav_name, im_path, id):
        n = self.n + 1
        negatives = []
    ...
    def __getitem__(self, index):
        ...
        negatives = self._SampleNeg(image_name[0], wav_name, french_name[0], self.data[index], id)
