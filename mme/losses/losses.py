...
def compute_matchmap_similarity_matrix_loss(
    ...
    # d_f = compute_matchmap_similarity_matrix(dutch_output, french_output, attention, simtype)
    ...
    # loss += contrastive_loss(d_f.unsqueeze(-1), pos_d_f.unsqueeze(-1), pos_f_d.unsqueeze(-1), neg_d_f.unsqueeze(-1), neg_f_d.unsqueeze(-1))  
