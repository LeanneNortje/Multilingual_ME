...
def loadModelAttriburesAndTrainingAMP(
    ...
    if 'english_model' in checkpoint: english_model.load_state_dict(checkpoint["english_model"])
    elif 'audio_model' in checkpoint: english_model.load_state_dict(checkpoint["audio_model"])
